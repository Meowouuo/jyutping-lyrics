...
(function() {
    const song = {
        ...
        lyrics: [
            ...
            { chars: ["忙","里","泄","露","各","种","的","丑","态","像","丧","尸"], jp: ["mong4", "leoi5", "sit3", "lou6", "gok3", "zung2", "dik1", "cau2", "taai3", "zoeng6", "song1", "si1"] },
            { chars: ["而","尴","尬","是","快","餐","厅","里"," ","我","误","把","酱","汁","四","周","乱","溅"], jp: ["ji4", "gaam1", "gaai3", "si6", "faai3", "caan1", "teng1", "leoi5", "", "ngo5", "ng6", "baa2", "zoeng3", "zap1", "sei3", "zau1", "lyun6", "zin3"] },
