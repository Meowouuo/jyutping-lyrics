...
(function() {
    const song = {
        ...
        lyrics: [
            ...
            { paragraphBreak: true },
            { chars: ["迟","两","秒","搭","上","地","下","铁"," ","能","与","你","碰","上","么"], jp: ["ci4", "loeng5", "miu5", "daap3", "soeng6", "dei6", "haa6", "tit3", "", "nang4", "jyu5", "nei5", "pung3", "soeng6", "mo1"] },
            ...
            { paragraphBreak: true },
            { chars: ["总","差","一","点","点","先","可","以","再","会","面"], jp: ["zung2","caa1","jat1","dim2","dim2","sin1","ho2","ji5","zoi3","wui6","min6"] },
            { chars: ["悔","不","当","初","轻","轻","放","过"," ","现","在","惩","罚","我"," ","分","手","分","错","了","么"], jp: ["fui3", "bat1", "dong1", "co1", "hing1", "hing1", "fong3", "gwo3", "", "jin6", "zoi6", "cing4", "fat6", "ngo5", "", "fan1", "sau2", "fan1", "co3", "liu5", "mo1"] },
