...
(function() {
    const song =     {
        ...
        lyrics: [
            ...
            { chars: ["即","使","你","不","爱"], jp: ["zik1","si2","nei5","bat1","ngoi3"] },
            { chars: ["亦","不","需","要","分","开"], jp: ["jik6","bat1","seoi1","jiu3","fan1","hoi1"] },
            { paragraphBreak: true },
            { chars: ["若","这","一","刻","我","竟","严","重","痴","呆"], jp: ["joek6","ze5","jat1","hak1","ngo5","ging2","jim4","zung6","ci1","ngoi4"] },
            { chars: ["根","本","不","需","要","被","爱"], jp: ["gan1","bun2","bat1","seoi1","jiu3","bei6","ngoi3"] },
            { chars: ["永","远","在","床","上","发","梦"], jp: ["wing5","jyun5","zoi6","cong4","soeng6","faat3","mung6"] },
            { chars: ["余","生","都","不","会","再","悲","哀"], jp: ["jyu4","sang1","dou1","bat1","wui5","zoi3","bei1","oi1"] },
            { paragraphBreak: true },
            { chars: ["人","总","需","要","勇","敢","生","存"], jp: ["jan4","zung2","seoi1","jiu3","jung5","gam2","sang1","cyun4"] },
            ...
            { chars: ["或","在","同","伴","新","婚","的","盛","宴"], jp: ["waak6","zoi6","tung4","bun6","san1","fan1","dik1","sing4","jin3"] },
            ...
            { chars: ["临","别","亦","听","得","到","你","讲","再","见"], jp: ["lam4","bit6","jik6","ting1","dak1","dou3","nei5","gong2","zoi3","gin3"] },
            { paragraphBreak: true },
            { chars: ["人","总","需","要","勇","敢","生","存"], jp: ["jan4","zung2","seoi1","jiu3","jung5","gam2","sang1","cyun4"] },
            { chars: ["我","还","是","重","新","许","愿"], jp: ["ngo5","waan4","si6","cung4","san1","heoi2","jyun6"] },
            { chars: ["例","如","学","会","承","受","失","恋"], jp: ["lai6","jyu4","hok6","wui5","sing4","sau6","sat1","lyun2"] },
