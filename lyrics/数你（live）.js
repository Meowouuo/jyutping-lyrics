...
(function() {
    const song = {
        ...
        lyrics: [
        { chars: ["开", "年", "大", "典", "V", "o", "l", ".", "3", "(", "杨", "千", "嬅", "演", "唱", "会", ")"], jp: ["hoi1", "nin4", "daai6", "din2", "", "", "", "", "saam1", "", "joeng4", "cin1", "waa6", "jin2", "coeng3", "wui6", ""] },
        { paragraphBreak: true },
        { chars: ["想", " ", "从", "幽", "幽", "的", "眼", "圈"], jp: ["soeng2", "", "cung4", "jau1", "jau1", "dik1", "ngaan5", "hyun1"] },
        { chars: ["逐", "公", "分", "那", "样", "转", " ", "为", "你", "点", "算", "着", "疲", "倦"], jp: ["zuk6", "gung1", "fan1", "naa5", "joeng6", "zyun2", "", "wai4", "nei5", "dim2", "syun3", "zoek6", "pei4", "gyun6"] },
        { chars: ["愿", "岁", "月", "难", "被", "我", "数", "完"], jp: ["jyun6", "seoi3", "jyut6", "naan4", "bei6", "ngo5", "sou3", "jyun4"] },
        { chars: ["你", "我", "一", "起", "能", "看", "转", "多", "少", "个", "圈"], jp: ["nei5", "ngo5", "jat1", "hei2", "nang4", "hon3", "zyun2", "do1", "siu2", "go3", "hyun1"] },
        { paragraphBreak: true },
        { chars: ["想", " ", "从", "撕", "开", "的", "戏", "飞"], jp: ["soeng2", "", "cung4", "si1", "hoi1", "dik1", "hei3", "fei1"] },
        { chars: ["逐", "分", "钟", "挂", "念", "你", " ", "是", "哪", "一", "套", "最", "回", "味"], jp: ["zuk6", "fan1", "zung1", "gwaa3", "nim6", "nei5", "", "si6", "naa5", "jat1", "tou3", "zeoi3", "wui4", "mei6"] },
        ...
        { paragraphBreak: true },
        { chars: ["无", "奈", "肉", "眼", "看", "不", "到", " ", "用", "两", "手", "摸", "不", "到"], jp: ["mou4", "noi6", "juk6", "ngaan5", "hon3", "bat1", "dou3", "", "jung6", "loeng5", "sau2", "mo2", "bat1", "dou3"] },
        { chars: ["怎", "么", "计", "算", "亦", "难", "料", "沉", "迷", "程", "度"], jp: ["zam2", "mo1", "gai3", "syun3", "jik6", "naan4", "liu6", "cam4", "mai4", "cing4", "dou6"] },
        ...
        { chars: ["只", "愿", "延", "续", "下", "去", "数", "得", "到", "苍", "老"], jp: ["zi2", "jyun6", "jin4", "zuk6", "haa6", "heoi3", "sou3", "dak1", "dou3", "cong1", "lou5"] },
        { paragraphBreak: true },
        { chars: ["一", "秒", "煎", "熬", " ", "一", "寸", "倾", "慕"], jp: ["jat1", "miu5", "zin1", "ngou4", "", "jat1", "cyun3", "king1", "mou6"] },
